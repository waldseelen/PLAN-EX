...
import { usePlannerHabitsStore } from '../store';
...
export function HabitDetailPage() {
    ...
    const toggleToday = () => {
        ...
        // If already done, we don't log again; otherwise log it
        if (!todayLog?.done) {
            logHabit(habit.id, today, habit.type === 'numeric' ? habit.target : undefined);
        }
    };
